...
class StarController(
    ...
    @Operation(summary = "천체 상세 조회", description = "이름과 관측후기/교육프로그램 수를 반환합니다.")
    fun getOrCreate(@PathVariable("objectName") objectName: String): ApiResponse<StarSummaryResponse> =
        ApiResponse.ok(starService.getOrCreateSummary(objectName))
